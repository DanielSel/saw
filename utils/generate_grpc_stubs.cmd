...
protoc --plugin=protoc-gen-grpc=%PLUGIN_GRPC% --js_out=import_style=commonjs,binary:"router\etc\saw\saw_service\grpc" --grpc_out="router\etc\saw\saw_service\grpc" -I common saw_pop.proto saw_auth.proto
protoc --plugin=protoc-gen-ts=%PLUGIN_TS% --ts_out="router\etc\saw\saw_service\grpc" -I common saw_pop.proto saw_auth.proto
