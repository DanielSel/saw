...
var common_saw_pop_pb = require('../common/saw_pop_pb.js');

function serialize_saw_Empty(arg) {
  if (!(arg instanceof common_saw_pop_pb.Empty)) {
...
function deserialize_saw_Empty(buffer_arg) {
  return common_saw_pop_pb.Empty.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_saw_Pop(arg) {
  if (!(arg instanceof common_saw_pop_pb.Pop)) {
...
function deserialize_saw_Pop(buffer_arg) {
  return common_saw_pop_pb.Pop.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_saw_PopStatus(arg) {
  if (!(arg instanceof common_saw_pop_pb.PopStatus)) {
...
function deserialize_saw_PopStatus(buffer_arg) {
  return common_saw_pop_pb.PopStatus.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_saw_SessionId(arg) {
  if (!(arg instanceof common_saw_pop_pb.SessionId)) {
...
function deserialize_saw_SessionId(buffer_arg) {
  return common_saw_pop_pb.SessionId.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SawPopService = exports.SawPopService = {
  getSessionId: {
    ...
    requestType: common_saw_pop_pb.Empty,
    responseType: common_saw_pop_pb.SessionId,
  ...
  submitPop: {
    ...
    requestStream: true,
    responseStream: false,
    requestType: common_saw_pop_pb.Pop,
    responseType: common_saw_pop_pb.PopStatus,
